...
class bbfinal extends StatefulWidget {
  const bbfinal({super.key});

  @override
  State<bbfinal> createState() => _bbfinalState();
}

class _bbfinalState extends State<bbfinal> {
  //Total Progress
        ...
        body: Center(
          child: ListView(
            children: [
              ...
              Text("                        "),
              Text("     T-Bar 10-12x3",style: TextStyle(fontWeight: FontWeight.w900,color: Colors.black,fontSize: 17),),
              ...
              //Flat Dumbell Press
              Text("                        "),
              Text("     Lat Pulldown Press 10-12x3",style: TextStyle(fontWeight: FontWeight.w900,color: Colors.black,fontSize: 17),),
              LinearProgressIndicator(
                backgroundColor: Colors.black26,
                color: Color.fromARGB(255,179 ,136 ,255 ),
              ...
              Text("                        "),
              Text("     Seated Row 10-12x3",style: TextStyle(fontWeight: FontWeight.w900,color: Colors.black,fontSize: 17),),
              LinearProgressIndicator(
                backgroundColor: Colors.black26,
                color: Color.fromARGB(255,179 ,136 ,255 ),
              ...
              //Peck Deck flyes
              Text("                        "),
              Text("     Straight Arm Cable Pushdown 10-12x3",style: TextStyle(fontWeight: FontWeight.w900,color: Colors.black,fontSize: 17),),
              LinearProgressIndicator(
                backgroundColor: Colors.black26,
                color: Color.fromARGB(255,179 ,136 ,255 ),
