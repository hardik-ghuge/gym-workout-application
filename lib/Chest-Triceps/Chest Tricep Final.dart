...
class ctfinal extends StatefulWidget {
  const ctfinal({super.key});

  @override
  State<ctfinal> createState() => _ctfinalState();
}

class _ctfinalState extends State<ctfinal> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          title: Text("Chest Tricep Workout",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w900),),
        ...
        body: Center(
          child: ListView(
            children: [
              ...
              Text("                        "),
              Text("     Incline Dumbell Press 10-12x3",style: TextStyle(fontWeight: FontWeight.w900,color: Colors.black,fontSize: 17),),
              ...
              //Flat Dumbell Press
              Text("                        "),
              Text("     Flat Dumbell Press 10-12x3",style: TextStyle(fontWeight: FontWeight.w900,color: Colors.black,fontSize: 17),),
              LinearProgressIndicator(
                backgroundColor: Colors.black26,
                color: Color.fromARGB(255,179 ,136 ,255 ),
              ...
              Text("                        "),
              Text("     Decline Dumbell Press 10-12x3",style: TextStyle(fontWeight: FontWeight.w900,color: Colors.black,fontSize: 17),),
              LinearProgressIndicator(
                backgroundColor: Colors.black26,
                color: Color.fromARGB(255,179 ,136 ,255 ),
          ...
          //Peck Deck flyes
              Text("                        "),
              Text("     Peck Deck Flyes 10-12x3",style: TextStyle(fontWeight: FontWeight.w900,color: Colors.black,fontSize: 17),),
              LinearProgressIndicator(
                backgroundColor: Colors.black26,
                color: Color.fromARGB(255,179 ,136 ,255 ),
              ...
              //Cable Chest Flyes
              Text("                        "),
              Text("     Cable Chest Flyes 10-12x3",style: TextStyle(fontWeight: FontWeight.w900,color: Colors.black,fontSize: 17),),
              LinearProgressIndicator(
                backgroundColor: Colors.black26,
                color: Color.fromARGB(255,179 ,136 ,255 ),
              ...
              //Tricep Pushdown
              Text("                        "),
              Text("     Tricep Pushdown 10-12x3",style: TextStyle(fontWeight: FontWeight.w900,color: Colors.black,fontSize: 17),),
              LinearProgressIndicator(
                backgroundColor: Colors.black26,
                color: Color.fromARGB(255,179 ,136 ,255 ),
