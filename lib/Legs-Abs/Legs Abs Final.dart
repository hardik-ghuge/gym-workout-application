...
class lafinal extends StatefulWidget {
  const lafinal({super.key});

  @override
  State<lafinal> createState() => _lafinalState();
}

class _lafinalState extends State<lafinal> {
  //Total Progress

  int total_excersises = 22;
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          title: Text("Legs Abs Workout",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w900),),
        ...
        body: Center(
          child: ListView(
            children: [
              ...
              Text("                        "),
              Text("     Squats 10-12x3",style: TextStyle(fontWeight: FontWeight.w900,color: Colors.black,fontSize: 17),),
              ...
              //Flat Dumbell Press
              Text("                        "),
              Text("     Front Squats 10-12x3",style: TextStyle(fontWeight: FontWeight.w900,color: Colors.black,fontSize: 17),),
              LinearProgressIndicator(
                backgroundColor: Colors.black26,
                color: Color.fromARGB(255,179 ,136 ,255 ),
              ...
              Text("                        "),
              Text("     Leg Press 10-12x3",style: TextStyle(fontWeight: FontWeight.w900,color: Colors.black,fontSize: 17),),
              LinearProgressIndicator(
                backgroundColor: Colors.black26,
                color: Color.fromARGB(255,179 ,136 ,255 ),
              ...
              //Peck Deck flyes
              Text("                        "),
              Text("     Leg Extensions 10-12x3",style: TextStyle(fontWeight: FontWeight.w900,color: Colors.black,fontSize: 17),),
              LinearProgressIndicator(
                backgroundColor: Colors.black26,
                color: Color.fromARGB(255,179 ,136 ,255 ),
              ...
              //Cable Chest Flyes
              Text("                        "),
              Text("     Crunches 10-12x3",style: TextStyle(fontWeight: FontWeight.w900,color: Colors.black,fontSize: 17),),
              LinearProgressIndicator(
                backgroundColor: Colors.black26,
                color: Color.fromARGB(255,179 ,136 ,255 ),
              ...
              //Tricep Pushdown
              Text("                        "),
              Text("     Russian Twists 10-12x3",style: TextStyle(fontWeight: FontWeight.w900,color: Colors.black,fontSize: 17),),
              LinearProgressIndicator(
                backgroundColor: Colors.black26,
                color: Color.fromARGB(255,179 ,136 ,255 ),
              ...
              //Tricep Kickbacks
              Text("                        "),
              Text("     Leg Raises 10-12x3",style: TextStyle(fontWeight: FontWeight.w900,color: Colors.black,fontSize: 17),),
              LinearProgressIndicator(
                backgroundColor: Colors.black26,
                color: Color.fromARGB(255,179 ,136 ,255 ),
              ...
              CheckboxListTile(title: Text("Plank",style:
              TextStyle(fontWeight: FontWeight.w700,color: Colors.black),),
                  value: plk,
                  controlAffinity: ListTileControlAffinity.leading,
                  checkColor: Colors.white,
